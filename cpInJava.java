...
class cpInJava {
	...
	public static void main(String... args) throws IOException {
		Scanner sc = new Scanner(new FileReader(System.in));
		PrintWriter pw = new PrintWriter(new BufferedOutputStream(new FileOutputStream(System.in)));
...
public class cpInJava {

	/*-------------------------------------------------------------------------------------------*/
	static Scanner getFileScanner(String inputFilePath, String outputFilePath) throws IOException {
		if (System.getProperty("ONLINE_JUDGE") != null) return new Scanner(System.in);
		System.setOut(new PrintStream(new FileOutputStream(outputFilePath)));
		return new Scanner(new File(inputFilePath));
	}
	/*-------------------------------------------------------------------------------------------*/
	public static void main(String[] args) throws IOException {
		Scanner read = getFileScanner("input.txt", "output.txt");
